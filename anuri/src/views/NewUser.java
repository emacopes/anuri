...
public class NewUser extends JDialog {
	...
	public NewUser() {
		...
		textField.setBounds(186, 12, 198, 20);
		...
		setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{textField, passwordField, passwordField_1, checkBox, checkBox_1, checkBox_2, checkBox_3, checkBox_4, checkBox_5, checkBox_6, checkBox_7, checkBox_8, checkBox_10, checkBox_9, checkBox_11, button, button_1}));
	}
}
